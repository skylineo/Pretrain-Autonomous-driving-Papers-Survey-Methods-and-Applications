# A Survey on Pre-Trained Model for Autopilot: Methods and Applications
This repo is constructed for collecting and categorizing papers about diffusion models according to our survey paper——[_**A Survey on Pre-Trained Model for Autopilot: Methods and Applications**_](website), which has been accepted by the journal **journal**. Considering the fast development of this field, we will continue to update **both [arxiv paper](website) and this repo**.
# Overview
